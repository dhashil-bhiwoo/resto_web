...
<!-- content -->
			<article id="content">
				<div class="wrap">
					<div class="box">
						<div>
							<h2 class="letter_spacing">New <span>Dish</span></h2>
							<form action="d_data.php" method="POST">
     <p>
        <label>Dish Name:</label>
        <input name="dname" required placeholder="Dish Name" type="text">
    </p>
    <p>
        <label>Price:</label>
    ...
    <p>
        ...
        <input name="is_spicy" required placeholder="1 for Yes, 0 for No" type="number" maxlength="1">
    </p>
    <p>
