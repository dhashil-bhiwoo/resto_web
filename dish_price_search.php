				...
				<nav>
					<ul id="menu">
						<li><a href="index.html">Restaurant</a></li>
							...
							<li class="active"><a href="dish_price_search.php">Search</a></li>
...
<!-- content -->
			<article id="content">
				<div class="wrap">
					<div class="box">
						<div>
							<h2 class="letter_spacing">Search by <span>Price</span></h2>
	<?php 
error_reporting(0);
print '
<h2>Search our dishes based on the minimun price</h2> 
...
if ($_POST['price']) {  
    ...
    echo "<h2>We have found $num dishes that cost at least \$$price</h2>"; 
    echo "<table border=1 cellspacing=0 cellpadding=4>"; 
    echo "<tr><th> Dish </th><th> Price </th><th> Spicy? </th></tr>"; 
     
    for ($i=0; $i<$num; $i++) { 
        $dish_name=mysql_result($result,$i,"dish_name"); 
        $price=mysql_result($result,$i,"price"); 
        $is_spicy = mysql_result($result,$i,"is_spicy")==1 ? "Yes" : "No"; 
        echo "<tr><td> $dish_name </td><td> $price </td><td> $is_spicy </td></tr> "; 
    } 
    echo "</table>";     
    mysql_close(); 
}  // end if 
